...
public class MusicOrganizer {
    ...
    public void addTrack(String title, String artist, int duration) {
        ...
        tracks.add(track);
        System.out.println(track.getTitle() + ", berhasil ditambahkan.");
    }

    public void removeTrack(int index) {
        if (index >= 0 && index < tracks.size()) {
            MusicTrack removedTrack = tracks.remove(index);
            System.out.println(removedTrack.getTitle() + ", berhasil dihapus.");
        } else {
    ...
    public void listAllTracks() {
        if (tracks.isEmpty()) {
            System.out.println("Belum ada track yang ditambahkan.");
        } else {
            System.out.println("\nList Track:");
    ...
    public void listMatchingTracks(String searchString) {
        ...
        if (!found) {
            System.out.println("Tidak ada track yang sesuai: " + searchString);
        }
    }
